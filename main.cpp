// main.cpp
// Single-file two-pass RV64-subset assembler for CS207 FCS Lab
// Supports the 37 instructions listed in the assignment and data directives.
...
static vector<string> tokenize(const string &line) {
    // split on whitespace but keep tokens like 12(x5) intact
...
static u32 encodeSB(i32 imm, u8 rs2, u8 rs1, u8 funct3, u8 opcode) {
    // imm bits: imm[12|10:5|4:1|11], LSB ignored
...
int main(int argc, char** argv) {
    ...
    // PASS 1: collect labels & measure addresses
    SymbolTable sym;
        ...
        if (inText) {
            ...
            try {
                ...
                if (oi.fmt == "R") {
                    ...
                    // encodeU expects full 32-bit with lower 12 bits zero; user gives top immediate value or numeric
                ...
                // add comment showing opcode/funct3/funct7 for debugging
            ...
            // handle directives .byte/.half/.word/.dword/.asciz
            if (op == ".byte") {
